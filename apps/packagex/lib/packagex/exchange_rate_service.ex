defmodule Packagex.ExchangeRateService do
  use GenServer
  ...
  @url_base "http://api.fixer.io/latest?base=#{@base_currency_symbol}&symbols="
  ...
  """
  def base_currency_symbol(), do: @base_currency_symbol
